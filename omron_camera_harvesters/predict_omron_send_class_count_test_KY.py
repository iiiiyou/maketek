...
class Detector:
    ...
    def append_defect(self, detected_defect):
        ...
        e = self.detected_defects.count('e')

        self.counts = (a,b,c,d,e)
...
try:
    ...
    while not done:
        with ia.fetch() as buffer:
            ...
            imS = cv2.resize(annotated_frame, (800, 800)) 
                    ...
                    if detector.counts[0] > 3:
                        ...
                        for i in range(5):
                            with ia.fetch() as buffer2:
                                ...
                                print("=======================================",i)
                                print("=======================================",i)
                                imS2 = cv2.resize(annotated_frame2, (800, 800)) 
